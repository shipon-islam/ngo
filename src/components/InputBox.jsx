export default function InputBox({ label, id, required,error, ...rest }) {
  return (
    <div className="flex flex-col">
      ...
      <input type="text" id={id} name={id} className="mt-4 border border-light-blue  h-14 pl-4 pr-2 placeholder:text-light-blue font-inter focus:outline-none focus:border focus:border-red-500 "  {...rest} />
