          ...
          <div className="container flex justify-between items-center  text-white">
            ...
            <div className="flex items-center gap-x-4">
              <div className="flex items-center gap-x-2">
                ...
                >
                  <Icon icon="flowbite:facebook-solid" width={16} height={16} />
                </a>
                ...
                <a
                  ...
                  className=" border rounded-full size-6 grid place-content-center  text-white py-1 px-3 hover:bg-white hover:text-darkgreen transition-colors duration-300"
                >
                  <Icon icon="flowbite:linkedin-solid" width={16} height={16} />
                </a>
                <a
          ...
          <nav className="container py-2 ">
            <div className="flex justify-between items-center   text-white">
              ...
              >
                ...
                <button  onClick={() => setIsShowNav((prev) => !prev)} className="bg-white/50 rounded-full p-0.5"><Icon icon="iconamoon:close" width="24" height="24"/></button>
                  </div>
                  <h5 className="font-medium mt-2">Building hope across Bangladesh since 2005</h5>
                </div>
                  <ul className="flex flex-col gap-y-9 md:gap-y-10 pt-8 px-6 text-black">
                    {headerLinks.map((link) => (
                      <li key={link.id} className="flex items-center gap-4">
                        <Icon icon={link.icon} width="18" height="18" className={`${link.color}`}/>
                        <Link
                          href={link.path}
